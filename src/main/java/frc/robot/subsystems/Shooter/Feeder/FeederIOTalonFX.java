...
public class FeederIOTalonFX implements FeederIO{
    ...
    public FeederIOTalonFX(){
      ...
      //  multiFeederMotor = new TalonFX(ShooterConstants.multiFeedertID,"Default Name");
        //singleFeederMotor = new TalonFX(ShooterConstants.singleFeederID,"Default Name");
    ...
    public double getSingleFeederVelocity(){
        return 0;// singleFeederMotor.getVelocity().getValueAsDouble();
    }
