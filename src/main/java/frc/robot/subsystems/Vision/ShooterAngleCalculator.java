...
5.098166337
    */ 
    static {
        ...
        flywheelSpeedMapHub.put(1.442809759,26.0-2);
        flywheelSpeedMapHub.put(2.01922287,27.5-2);
        flywheelSpeedMapHub.put(2.511019912,29.0-0.5-2);
        flywheelSpeedMapHub.put(3.034157419,30.0-0.5-2);
        flywheelSpeedMapHub.put(3.518755036,31.0-1.0-2);
        flywheelSpeedMapHub.put(4.076567183,32.5-1.0-2);
        flywheelSpeedMapHub.put(4.515152268,33.5-1.5-2);
        flywheelSpeedMapHub.put(5.098166337,35.0-1.5-2);
        flywheelSpeedMapHub.put(5.506476197,35.5-1.5-2 );
    ...
    public static ShooterAngle getShooterAngle(double vx, double vy, double XToHub, double YToHub, InterpolatingDoubleTreeMap flywheelSpeedMap, InterpolatingDoubleTreeMap timeOfFlightMap, InterpolatingTreeMap<Double, Rotation2d> hoodAngleMap){
        ...
        double rotation = SwerveSubsystem.getInstance().getRobotPose().getRotation().getRadians();//gets the swevers rotations and translates it to radians 
