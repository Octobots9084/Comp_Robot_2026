...
public class PieceVisionCamera{ //TODO piecevis (whole class?)
    private PhotonCamera camera;
    private PhotonTrackedTarget target;
    private double yawRotation;
    private double xTransform;
    private double IFOV = (Math.PI/2)/180;
    private double halfAlgae = 413/2; //413 //TODO piecevis

    //ground align = set intaking, 
